                ...
                rx.el.div(
                    ...
                    rx.el.div(
                        ...
                        rx.el.button(
                            ...
                            disabled=PrintState.is_share_disabled,
                            class_name="w-full p-3 bg-purple-600 text-white font-semibold rounded-lg hover:bg-purple-700 transition-colors shadow-lg disabled:bg-gray-400 disabled:cursor-not-allowed flex items-center justify-center",
                        ),
